...
select film_name, post_name, client_name from sell, client, post, films, postf, pay, seans where sell.pay_id=pay.pay_id AND pay.client_id=client.client_id AND sell.seans_id=seans.seans_id
AND seans.film_id=films.film_id AND films.postf_id=postf.postf_id AND postf.post_id=post.post_id;